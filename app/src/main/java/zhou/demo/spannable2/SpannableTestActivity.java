...
public class SpannableTestActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_span2);
        ...
        mBtnViewPager.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(SpannableTestActivity.this, ViewPagerActivity.class));
            }
        });
        ...
        switch((SpanType)mSpinner.getSelectedItem()) {
            ...
            case LOCALE_SPAN:
                if(Build.VERSION.SDK_INT >= 17){
                    ...
                    ToasterDebug.toastShort("API 17才支持LocaleSpan");
                }
                break;
            case SCALEX_SPAN:
